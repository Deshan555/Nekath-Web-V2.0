...
export const Nav = () => (
  ...
  >
    <Link to="/" className="font-cinzel-dec text-xl font-bold text-[var(--gold)] tracking-[0.12em] flex items-center gap-2 no-underline">
    ...
    <div className="flex items-center gap-6">
      <Link to="/login" className="font-cinzel text-[0.65rem] tracking-[0.2em] uppercase text-[var(--cream-dim)] hover:text-[var(--gold)] transition-colors no-underline">
        Sign In
      </Link>
      <Link to="/register">
        <Button 
