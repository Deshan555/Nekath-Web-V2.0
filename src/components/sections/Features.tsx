        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[var(--gold)]/10">
          {features.map((f, i) => (
            ...
            >
              ...
              <div 
                className="w-16 h-16 rounded-2xl flex items-center justify-center mb-8 bg-white/5 border border-white/10 group-hover:border-[var(--gold)]/30 transition-colors duration-500"
                style={{ filter: `drop-shadow(0 0 12px ${f.glow})` }}
              >
                <FontAwesomeIcon icon={f.icon} className="text-3xl text-[var(--gold)]" />
              </div>
