    ...
    <div className="relative min-h-screen bg-[var(--midnight)] text-[var(--cream)] overflow-x-hidden font-poppins pb-20">
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 max-w-5xl">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
          <button onClick={() => navigate('/dashboard')} className="font-cinzel text-[0.6rem] tracking-[0.2em] uppercase text-[var(--gold-dim)] hover:text-[var(--gold)] mb-6 flex items-center gap-2 mx-auto transition-colors">
          ...
          <p className="font-poppins text-[var(--cream-dim)] opacity-60 italic max-w-2xl mx-auto">Master the elements of time. Align your actions with the pulse of the universe.</p>
        </motion.div>
        ...
        <Row gutter={[24, 24]}>
          <Col xs={24} lg={16}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
               {pancanga.map((p, i) => (
                 <Card key={i} className="bg-[var(--panel-bg)] border border-[var(--panel-border)] p-4 shadow-xl">
              ...
              {activities.map((a, i) => (
                <div key={i} className="bg-[var(--panel-bg)] border border-[var(--panel-border)] p-6 group hover:border-[var(--gold)]/30 transition-all">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-sm font-cinzel tracking-wider text-[var(--cream)]">{a.name}</span>
                    <Tag 
                  ...
                  <p className="text-[0.65rem] text-[var(--cream-dim)] opacity-60 leading-relaxed italic">{a.logic}</p>
                </div>
              ))}
            </div>
          </Col>
          ...
          <Col xs={24} lg={8}>
            <Card className="bg-gradient-to-br from-[var(--gold)] to-[var(--gold-dim)] p-1 border-none shadow-2xl mb-8">
               <div className="bg-[var(--midnight)] p-8">
                  ...
                  <div className="mb-8">
                    <p className="text-4xl font-cinzel text-[var(--cream)] mb-2">15:12 - 16:45</p>
                  ...
                  <p className="text-[0.6rem] text-[var(--cream-dim)] opacity-60 leading-relaxed">
                  ...
                  <div className="flex items-center gap-4 text-[var(--cream-dim)]">
            ...
            <Card className="bg-white/5 border border-[var(--gold)]/15 p-6">
               <h3 className="font-cinzel text-xs text-[var(--gold-dim)] uppercase tracking-widest mb-4">Aitificial Insight</h3>
               <p className="text-[0.65rem] text-[var(--cream-dim)] leading-relaxed mb-6 italic opacity-80">
               ...
               <Button block className="bg-[var(--gold)]/10 border-[var(--gold)]/30 text-[var(--gold)] font-cinzel text-[0.6rem] h-auto py-2 uppercase tracking-widest">
